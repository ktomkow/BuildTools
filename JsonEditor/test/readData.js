...
describe('Read and deserialize object', () => {
  ...
  it('Json with array', function() {
    ...
    instance.should.have.property('description', 'this json contains array of numbers');
...
describe('Read and deserialize strange json', () => {
  ...
  it('Comment in json using double slash', function() {
    ...
    instance.connectionStrings.should.have.property('mongo', 'mongodb://localhost:27017');
    instance.connectionStrings.should.have.property('logs', 'C:\\Logs\\TheApp\\logs.log');
  });
})